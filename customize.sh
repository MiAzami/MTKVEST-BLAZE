...
ui_print "Version        : 1.1.4 (122) GORE "
...
ui_print "    Selected: $H"
case $H in
    1 ) TEXT8="Yes"; sed -i '/debug.enabletr/s/.*/debug.enabletr=false/' $MODPATH/system.prop; sed -i '/debug.performance.tuning/s/.*/debug.performance.tuning=1/' $MODPATH/system.prop; sed -i '/hwui.render_dirty_regions/s/.*/hwui.render_dirty_regions=true/' $MODPATH/system.prop; sed -i '/vendor.gralloc.disable_ubwc/s/.*/vendor.gralloc.disable_ubwc=0/' $MODPATH/system.prop; sed -i '/debug.sf.hw/s/.*/debug.sf.hw=1/' $MODPATH/system.prop; sed -i '/debug.egl.hw/s/.*/debug.egl.hw=1/' $MODPATH/system.prop; sed -i '/debug.egl.profiler/s/.*/debug.egl.profiler=1/' $MODPATH/system.prop; sed -i '/debug.overlayui.enable/s/.*/debug.overlayui.enable=1' $MODPATH/system.prop; sed -i '/persist.sys.ui.hw/s/.*/persist.sys.ui.hw=1' $MODPATH/system.prop; sed -i '/persist.sys.ui.rendering/s/.*/persist.sys.ui.rendering=1' $MODPATH/system.prop; sed -i '/debug.gralloc.gfx_ubwc_disable/s/.*/debug.gralloc.gfx_ubwc_disable=0' $MODPATH/system.prop; sed -i '/persist.sys.gpu.rendering/s/.*/persist.sys.gpu.rendering=1' $MODPATH/system.prop; sed -i '/video.accelerate.hw/s/.*/video.accelerate.hw=1' $MODPATH/system.prop; sed -i '/debug.hwui.use_buffer_age/s/.*/debug.hwui.use_buffer_age=false' $MODPATH/system.prop; sed -i '/ro.config.enable.hw_accel/s/.*/ro.config.enable.hw_accel=true' $MODPATH/system.prop; sed -i '/ro.vendor.gpu.optimize.level/s/.*/ro.vendor.gpu.optimize.level=3' $MODPATH/system.prop; sed -i '/ro.vendor.gpu.optimize.preload/s/.*/ro.vendor.gpu.optimize.preload=1' $MODPATH/system.prop; sed -i '/ro.vendor.gpu.optimize.texture_control/s/.*/ro.vendor.gpu.optimize.texture_control=true' $MODPATH/system.prop; sed -i '/ro.vendor.gpu.optimize.memory_compaction/s/.*/ro.vendor.gpu.optimize.memory_compaction=true' $MODPATH/system.prop; sed -i '/ro.vendor.gpu.optimize.fork_detector/s/.*/ro.vendor.gpu.optimize.fork_detector=true' $MODPATH/system.prop;;
    2 ) TEXT8="No";;
esac
ui_print "    $TEXT9"
ui_print ""
...
case $J in
    ...
    5 ) TEXT10="CPU"; sed -i '/debug.composition.type/s/.*/debug.composition.type=cpu/' $MODPATH/system.prop;;
    6 ) TEXT10="Skip";;
esac
ui_print "    $TEXT10"
ui_print ""
